...
Partial Class AdminDeleteDocumentForm
    ...
    Private Sub InitializeComponent()
        ...
        lblFormTitle.Text      = "Delete Document"
        ...
        ' Warning icon (using system icon rendered as label)
        ...
        lblSubMsg.Text      = "This action cannot be undone. The document will be permanently removed."
        ...
        Me.Name                = "AdminDeleteDocumentForm"
