Public Class UserDocumentTypesPanel
    ...
    Private Sub UserDocumentTypesPanel_Load(sender As Object, e As EventArgs) Handles Me.Load
        BuildCards()
    End Sub
    ...
    Private Sub BuildCards()
        ...
        Try
            counts = DocumentRepository.GetActiveTypeCounts()
